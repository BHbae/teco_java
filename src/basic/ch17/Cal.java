...
public class Cal {
	...
	public Cal() {
		System.out.println("Cal() 부모생성자 호출");
	}
...
class Cal2 extends Cal {
	public Cal2() {
		System.out.println("Cal2()자식생성자호출");
	}
	...
	// 부모 코드의 기능을 변경 하고 싶다면 --> 재정의 하고 싶다면
	// 오버라이드 처리 한다.
//	public int multiply(int n1, int n2) {
//		// a 또는 b --> 논리연산자 --> 논리 합 --> 둘중에 하나라도 true 라면 --> true 이다.
//		// a 그리고 b --> 논리연산자 --> 논리 곱 --> 전부 true 여야 --> true 이다.
//	if (n1 == 0 || n2 == 0) {
